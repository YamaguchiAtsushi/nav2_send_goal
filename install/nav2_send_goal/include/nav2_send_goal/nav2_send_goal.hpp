...
private:
  ...
  size_t SendWaypointsOnce(size_t sending_index, std::vector<waypoint_info>& waypoints);
...
private:
  ...
  std::vector<waypoint_info> waypoints_1_;
  std::vector<waypoint_info> waypoints_2_;
  std::vector<waypoint_info> waypoints_3_;
  std::vector<waypoint_info> waypoints_4_;
